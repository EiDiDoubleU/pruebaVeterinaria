...
namespace prueba1.Controllers
{
    public class RegistroAnimalesController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
            //agregamos al bind
        public ActionResult Create([Bind(Include = "Id,tblRegistroDueñoId,ClaseAnimal,Raza,Edad,Color,Estatura")] RegistroAnimales registroAnimales)
        {
        ...
        public ActionResult Edit([Bind(Include = "Id,tblRegistroDueñoId,ClaseAnimal,Raza,Edad,Color,Estatura")] RegistroAnimales registroAnimales)
        {
            if (ModelState.IsValid)
            {
